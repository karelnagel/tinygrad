...
R_ARC_TLS_DTPOFF_S9 = 0x4a # macro
...
__all__ = \
    ...
    'AT_PHENT', 'AT_PHNUM', 'AT_PLATFORM', 'AT_RANDOM', 'AT_SECURE',
    ...
    'DT_RELASZ', 'DT_RELCOUNT', 'DT_RELENT', 'DT_RELSZ', 'DT_RPATH',
    ...
    'EF_SH1', 'EF_SH2', 'EF_SH2A', 'EF_SH2A_NOFPU', 'EF_SH2A_SH3E',
    'EF_SH2A_SH3_NOFPU', 'EF_SH2A_SH4', 'EF_SH2A_SH4_NOFPU',
    'EF_SH2E', 'EF_SH3', 'EF_SH3E', 'EF_SH3_DSP', 'EF_SH3_NOMMU',
    'EF_SH4', 'EF_SH4A', 'EF_SH4AL_DSP', 'EF_SH4A_NOFPU',
    'EF_SH4_NOFPU', 'EF_SH4_NOMMU_NOFPU', 'EF_SH_DSP',
    'EF_SH_MACH_MASK', 'EF_SH_UNKNOWN', 'EF_SPARCV9_MM',
    'EF_SPARCV9_PSO', 'EF_SPARCV9_RMO', 'EF_SPARCV9_TSO',
    'EF_SPARC_32PLUS', 'EF_SPARC_EXT_MASK', 'EF_SPARC_HAL_R1',
    'EF_SPARC_LEDATA', 'EF_SPARC_SUN_US1', 'EF_SPARC_SUN_US3',
    'EI_ABIVERSION', 'EI_CLASS', 'EI_DATA', 'EI_MAG0', 'EI_MAG1',
    'EI_MAG2', 'EI_MAG3', 'EI_NIDENT', 'EI_OSABI', 'EI_PAD',
    'EI_VERSION', 'ELFCLASS32', 'ELFCLASS64', 'ELFCLASSNONE',
    'ELFCLASSNUM', 'ELFCOMPRESS_HIOS', 'ELFCOMPRESS_HIPROC',
    'ELFCOMPRESS_LOOS', 'ELFCOMPRESS_LOPROC', 'ELFCOMPRESS_ZLIB',
    'ELFDATA2LSB', 'ELFDATA2MSB', 'ELFDATANONE', 'ELFDATANUM',
    'ELFMAG', 'ELFMAG0', 'ELFMAG1', 'ELFMAG2', 'ELFMAG3',
    'ELFOSABI_AIX', 'ELFOSABI_ARM', 'ELFOSABI_ARM_AEABI',
    'ELFOSABI_FREEBSD', 'ELFOSABI_GNU', 'ELFOSABI_HPUX',
    'ELFOSABI_IRIX', 'ELFOSABI_LINUX', 'ELFOSABI_MODESTO',
    'ELFOSABI_NETBSD', 'ELFOSABI_NONE', 'ELFOSABI_OPENBSD',
    'ELFOSABI_SOLARIS', 'ELFOSABI_STANDALONE', 'ELFOSABI_SYSV',
    'ELFOSABI_TRU64', 'ELF_NOTE_ABI', 'ELF_NOTE_FDO', 'ELF_NOTE_GNU',
    'ELF_NOTE_OS_FREEBSD', 'ELF_NOTE_OS_GNU', 'ELF_NOTE_OS_LINUX',
    'ELF_NOTE_OS_SOLARIS2', 'ELF_NOTE_PAGESIZE_HINT',
    'ELF_NOTE_SOLARIS', 'EM_386', 'EM_56800EX', 'EM_68HC05',
    'EM_68HC08', 'EM_68HC11', 'EM_68HC12', 'EM_68HC16', 'EM_68K',
    'EM_78KOR', 'EM_8051', 'EM_860', 'EM_88K', 'EM_960', 'EM_AARCH64',
    'EM_ALPHA', 'EM_ALTERA_NIOS2', 'EM_AMDGPU', 'EM_ARC', 'EM_ARCA',
    'EM_ARCV2', 'EM_ARC_A5', 'EM_ARC_COMPACT', 'EM_ARM', 'EM_AVR',
    'EM_AVR32', 'EM_BA1', 'EM_BA2', 'EM_BLACKFIN', 'EM_BPF',
    'EM_C166', 'EM_CDP', 'EM_CE', 'EM_CLOUDSHIELD', 'EM_COGE',
    'EM_COLDFIRE', 'EM_COOL', 'EM_COREA_1ST', 'EM_COREA_2ND', 'EM_CR',
    'EM_CR16', 'EM_CRAYNV2', 'EM_CRIS', 'EM_CRX', 'EM_CSKY',
    'EM_CSR_KALIMBA', 'EM_CUDA', 'EM_CYPRESS_M8C', 'EM_D10V',
    'EM_D30V', 'EM_DSP24', 'EM_DSPIC30F', 'EM_DXP', 'EM_ECOG16',
    'EM_ECOG1X', 'EM_ECOG2', 'EM_EMX16', 'EM_EMX8', 'EM_ETPU',
    'EM_EXCESS', 'EM_F2MC16', 'EM_FAKE_ALPHA', 'EM_FIREPATH',
    'EM_FR20', 'EM_FR30', 'EM_FT32', 'EM_FX66', 'EM_H8S', 'EM_H8_300',
    'EM_H8_300H', 'EM_H8_500', 'EM_HUANY', 'EM_IAMCU', 'EM_IA_64',
    'EM_INTELGT', 'EM_IP2K', 'EM_JAVELIN', 'EM_K10M', 'EM_KM32',
    'EM_KMX32', 'EM_KVARC', 'EM_L10M', 'EM_LATTICEMICO32', 'EM_M16C',
    'EM_M32', 'EM_M32C', 'EM_M32R', 'EM_MANIK', 'EM_MAX', 'EM_MAXQ30',
    ...
    'Elf32_Rela', 'Elf32_Section', 'Elf32_Shdr', 'Elf32_Sword',
    'Elf32_Sxword', 'Elf32_Sym', 'Elf32_Syminfo', 'Elf32_Verdaux',
    'Elf32_Verdef', 'Elf32_Vernaux', 'Elf32_Verneed', 'Elf32_Versym',
    'Elf32_Word', 'Elf32_Xword', 'Elf32_auxv_t', 'Elf32_gptab',
    'Elf64_Addr', 'Elf64_Chdr', 'Elf64_Dyn', 'Elf64_Ehdr',
    'Elf64_Half', 'Elf64_Lib', 'Elf64_Move', 'Elf64_Nhdr',
    'Elf64_Off', 'Elf64_Phdr', 'Elf64_Rel', 'Elf64_Rela',
    'Elf64_Section', 'Elf64_Shdr', 'Elf64_Sword', 'Elf64_Sxword',
    'Elf64_Sym', 'Elf64_Syminfo', 'Elf64_Verdaux', 'Elf64_Verdef',
    'Elf64_Vernaux', 'Elf64_Verneed', 'Elf64_Versym', 'Elf64_Word',
    'Elf64_Xword', 'Elf64_auxv_t', 'Elf_MIPS_ABIFlags_v0',
    'Elf_Options', 'Elf_Options_Hw', 'F_LOCK', 'F_OK', 'F_TEST',
    'F_TLOCK', 'F_ULOCK', 'GNU_PROPERTY_1_NEEDED',
    ...
    'NT_MIPS_MSA', 'NT_PLATFORM', 'NT_PPC_DSCR', 'NT_PPC_EBB',
    'NT_PPC_PKEY', 'NT_PPC_PMU', 'NT_PPC_PPR', 'NT_PPC_SPE',
    'NT_PPC_TAR', 'NT_PPC_TM_CDSCR', 'NT_PPC_TM_CFPR',
    'NT_PPC_TM_CGPR', 'NT_PPC_TM_CPPR', 'NT_PPC_TM_CTAR',
    'NT_PPC_TM_CVMX', 'NT_PPC_TM_CVSX', 'NT_PPC_TM_SPR', 'NT_PPC_VMX',
    'NT_PPC_VSX', 'NT_PRCRED', 'NT_PRFPREG', 'NT_PRFPXREG',
    'NT_PRPSINFO', 'NT_PRSTATUS', 'NT_PRXFPREG', 'NT_PRXREG',
    'NT_PSINFO', 'NT_PSTATUS', 'NT_S390_CTRS', 'NT_S390_GS_BC',
    'NT_S390_GS_CB', 'NT_S390_HIGH_GPRS', 'NT_S390_LAST_BREAK',
    'NT_S390_PREFIX', 'NT_S390_RI_CB', 'NT_S390_SYSTEM_CALL',
    'NT_S390_TDB', 'NT_S390_TIMER', 'NT_S390_TODCMP',
    'NT_S390_TODPREG', 'NT_S390_VXRS_HIGH', 'NT_S390_VXRS_LOW',
    'NT_SIGINFO', 'NT_TASKSTRUCT', 'NT_UTSNAME', 'NT_VERSION',
    'NT_VMCOREDD', 'NT_X86_XSTATE', 'ODK_EXCEPTIONS', 'ODK_FILL',
    ...
    'PT_PARISC_ARCHEXT', 'PT_PARISC_UNWIND', 'PT_PHDR', 'PT_SHLIB',
    'PT_SUNWBSS', 'PT_SUNWSTACK', 'PT_TLS', 'RHF_CORD',
    'RHF_DEFAULT_DELAY_LOAD', 'RHF_DELTA_C_PLUS_PLUS',
    'RHF_GUARANTEE_INIT', 'RHF_GUARANTEE_START_INIT', 'RHF_NONE',
    ...
    'R_ARC_32', 'R_ARC_32_ME', 'R_ARC_8', 'R_ARC_B22_PCREL',
    'R_ARC_B26', 'R_ARC_COPY', 'R_ARC_GLOB_DAT', 'R_ARC_GOT32',
    'R_ARC_GOTOFF', 'R_ARC_GOTPC', 'R_ARC_GOTPC32', 'R_ARC_H30',
    'R_ARC_H30_ME', 'R_ARC_JUMP_SLOT', 'R_ARC_N16', 'R_ARC_N24',
    'R_ARC_N32', 'R_ARC_N32_ME', 'R_ARC_N8', 'R_ARC_NONE',
    'R_ARC_PC32', 'R_ARC_PLT32', 'R_ARC_RELATIVE', 'R_ARC_S13_PCREL',
    'R_ARC_S21H_PCREL', 'R_ARC_S21W_PCREL', 'R_ARC_S25H_PCREL',
    'R_ARC_S25W_PCREL', 'R_ARC_SDA', 'R_ARC_SDA16_LD',
    'R_ARC_SDA16_LD1', 'R_ARC_SDA16_LD2', 'R_ARC_SDA32',
    'R_ARC_SDA32_ME', 'R_ARC_SDA_LDST', 'R_ARC_SDA_LDST1',
    'R_ARC_SDA_LDST2', 'R_ARC_SECTOFF', 'R_ARC_SECTOFF_1',
    'R_ARC_SECTOFF_2', 'R_ARC_SECTOFF_ME', 'R_ARC_SECTOFF_ME_1',
    'R_ARC_SECTOFF_ME_2', 'R_ARC_SECTOFF_S9', 'R_ARC_SECTOFF_U8',
    'R_ARC_TLS_DTPMOD', 'R_ARC_TLS_DTPOFF', 'R_ARC_TLS_DTPOFF_S9',
    'R_ARC_TLS_GD_CALL', 'R_ARC_TLS_GD_GOT', 'R_ARC_TLS_GD_LD',
    'R_ARC_TLS_IE_GOT', 'R_ARC_TLS_LE_32', 'R_ARC_TLS_LE_S9',
    'R_ARC_TLS_TPOFF', 'R_ARC_W', 'R_ARC_W_ME', 'R_ARM_ABS12',
    'R_ARM_ABS16', 'R_ARM_ABS32', 'R_ARM_ABS32_NOI', 'R_ARM_ABS8',
    'R_ARM_ALU_PCREL_15_8', 'R_ARM_ALU_PCREL_23_15',
    ...
    'R_IA64_TPREL64LSB', 'R_IA64_TPREL64MSB', 'R_M32R_10_PCREL',
    ...
    'R_MICROBLAZE_TLSTPREL32', 'R_MIPS_16', 'R_MIPS_26', 'R_MIPS_32',
    'R_MIPS_64', 'R_MIPS_ADD_IMMEDIATE', 'R_MIPS_CALL16',
    'R_MIPS_CALL_HI16', 'R_MIPS_CALL_LO16', 'R_MIPS_COPY',
    'R_MIPS_DELETE', 'R_MIPS_GLOB_DAT', 'R_MIPS_GOT16',
    'R_MIPS_GOT_DISP', 'R_MIPS_GOT_HI16', 'R_MIPS_GOT_LO16',
    'R_MIPS_GOT_OFST', 'R_MIPS_GOT_PAGE', 'R_MIPS_GPREL16',
    'R_MIPS_GPREL32', 'R_MIPS_HI16', 'R_MIPS_HIGHER',
    'R_MIPS_HIGHEST', 'R_MIPS_INSERT_A', 'R_MIPS_INSERT_B',
    'R_MIPS_JALR', 'R_MIPS_JUMP_SLOT', 'R_MIPS_LITERAL',
    'R_MIPS_LO16', 'R_MIPS_NONE', 'R_MIPS_NUM', 'R_MIPS_PC16',
    'R_MIPS_PJUMP', 'R_MIPS_REL16', 'R_MIPS_REL32', 'R_MIPS_RELGOT',
    'R_MIPS_SCN_DISP', 'R_MIPS_SHIFT5', 'R_MIPS_SHIFT6', 'R_MIPS_SUB',
    'R_MIPS_TLS_DTPMOD32', 'R_MIPS_TLS_DTPMOD64',
    'R_MIPS_TLS_DTPREL32', 'R_MIPS_TLS_DTPREL64',
    'R_MIPS_TLS_DTPREL_HI16', 'R_MIPS_TLS_DTPREL_LO16',
    'R_MIPS_TLS_GD', 'R_MIPS_TLS_GOTTPREL', 'R_MIPS_TLS_LDM',
    ...
    'R_RISCV_SET32', 'R_RISCV_SET6', 'R_RISCV_SET8', 'R_RISCV_SUB16',
    'R_RISCV_SUB32', 'R_RISCV_SUB6', 'R_RISCV_SUB64', 'R_RISCV_SUB8',
    'R_RISCV_TLS_DTPMOD32', 'R_RISCV_TLS_DTPMOD64',
    'R_RISCV_TLS_DTPREL32', 'R_RISCV_TLS_DTPREL64',
    'R_RISCV_TLS_GD_HI20', 'R_RISCV_TLS_GOT_HI20',
    'R_RISCV_TLS_TPREL32', 'R_RISCV_TLS_TPREL64', 'R_RISCV_TPREL_ADD',
    'R_RISCV_TPREL_HI20', 'R_RISCV_TPREL_I', 'R_RISCV_TPREL_LO12_I',
    'R_RISCV_TPREL_LO12_S', 'R_RISCV_TPREL_S', 'R_SH_ALIGN',
    'R_SH_CODE', 'R_SH_COPY', 'R_SH_COUNT', 'R_SH_DATA', 'R_SH_DIR32',
    'R_SH_DIR8BP', 'R_SH_DIR8L', 'R_SH_DIR8W', 'R_SH_DIR8WPL',
    'R_SH_DIR8WPN', 'R_SH_DIR8WPZ', 'R_SH_GLOB_DAT',
    'R_SH_GNU_VTENTRY', 'R_SH_GNU_VTINHERIT', 'R_SH_GOT32',
    'R_SH_GOTOFF', 'R_SH_GOTPC', 'R_SH_IND12W', 'R_SH_JMP_SLOT',
    'R_SH_LABEL', 'R_SH_NONE', 'R_SH_NUM', 'R_SH_PLT32', 'R_SH_REL32',
    'R_SH_RELATIVE', 'R_SH_SWITCH16', 'R_SH_SWITCH32', 'R_SH_SWITCH8',
    ...
    'SHT_PROGBITS', 'SHT_REL', 'SHT_RELA', 'SHT_SHLIB', 'SHT_STRTAB',
    ...
    'STO_PPC64_LOCAL_BIT', 'STO_PPC64_LOCAL_MASK', 'STT_ARM_16BIT',
